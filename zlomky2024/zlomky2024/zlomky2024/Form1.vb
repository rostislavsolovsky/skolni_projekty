            ...
            If Math.Abs(suma) > suma1 Then
                If suma > 0 Then
                    ...
                    If cela <> 0 Then
                        ...
                        Else
                            TextBox4.Text = TextBox4.Text & Chr(34) & " = " & Chr(34)
                            TextBox4.Text = TextBox4.Text & cela
                            GoTo dokonceni
...
chyba:
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        ...
        For i = 1 To pocetp
            ...
            'vyřešíme převod na zlomky
            If Math.Abs(a2) > a3 Or Math.Abs(b2) > b3 Then
                TextBox4.Text = TextBox4.Text & nazlomek1(a2, a3, a4) & Chr(34) & " · " & Chr(34) & nazlomek2(b2, b3, b4) & Chr(34) & " = " & Chr(34)
            End If

            'vyřešíme krácení
            If Math.Abs(del1(a2, b3)) <> 1 Or Math.Abs(del1(b2, a3)) <> 1 Then
                suma2 = Math.Abs(del1(a2, b3))
                If suma <> 1 Then
                    'budeme poprvé krátit
                    a2 = a2 / suma2
                    b3 = b3 / suma2
                End If
                suma2 = Math.Abs(del1(b2, a3))
                If suma <> 1 Then
                    'budeme podruhé krátit
                    b2 = b2 / suma2
                    a3 = a3 / suma2
                End If
                TextBox4.Text = TextBox4.Text & nazlomek1(a2, a3, a4) & Chr(34) & " · " & Chr(34) & nazlomek2(b2, b3, b4) & Chr(34) & " = " & Chr(34)
            ...
            'vyřešíme mezivýsledek
            suma = a2 * b2
            suma1 = a3 * b3
            If suma > 0 Then
                TextBox4.Text = TextBox4.Text & "{" & CStr(suma) & "} over {" & CStr(suma1) & "}"
            Else
                TextBox4.Text = TextBox4.Text & Chr(34) & "-" & Chr(34) & "{" & CStr(-1 * suma) & "} over {" & CStr(suma1) & "}"
            End If

            'dodatečná konrola na jmenovatel rovný jedné
            If suma1 = 1 Then
                TextBox4.Text = TextBox4.Text & Chr(34) & " = " & Chr(34)
                TextBox4.Text = TextBox4.Text & suma
                GoTo dokonceni
            End If
